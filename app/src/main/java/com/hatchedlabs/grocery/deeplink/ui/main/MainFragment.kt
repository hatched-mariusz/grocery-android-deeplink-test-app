...
//         TODO   LinkExample("Go to search screen with selected store", "${SCHEMA}://${HOST}/main/search?selectedStore=72&fulfillmentMethod=pickup"),
            ...
            LinkExample("Show order history", "${getCurrentSchema()}://${getCurrentHost()}/order/"),
            LinkExample("Show user past order", "${getCurrentSchema()}://${getCurrentHost()}/order/order?orderId=699KF66D"),
